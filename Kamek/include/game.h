...
struct Remocon {
	virtual ~Remocon();  //0x0
	int id;  //0x4
	int controllerType;  //0x8
	u32 hold;  //0xC
	u32 prevHold;  //0x10
	u32 heldButtons;  //0x14
	u32 lastHeldButtons;  //0x18
	u32 nowPressed;  //0x1C
	u32 _20;  //0x20,
	u32 _24;  //0x24
	u32 _28;  //0x28
	...
	Vec lastAcc;  //0x40
	Vec2 accVertX;  //0x4C
	Vec2 lastAccVertX;  //0x54
	Vec2 accVertY;  //0x5C
	Vec2 lastAccVertY;  //0x64
	Vec2 accVertZ;  //0x6C
	Vec2 angle;  //0x74
	Vec2 lastVec_74;  //0x7C
	float moveDistance;  //0x84
	float lastMoveDistance;  //0x88
	u8 isShaking;  //0x8C
	u8 _8D;  //0x8D
	u16 tiltAmount;  //0x8E
	u8 shakeTimer1;  //0x90
...
public:
	...
	virtual const char *GetNameString();
};
...
ReplayHeader : public dReplayPlay_c {
public:
	int world;
	int level;
	int area;
	...
	u32 character;
	u32 powerup;
	u32 isStar;  //acts like a bool
	u32 unk3;
	bool useNunchuk;  //custom; unused byte in vanilla
	bool redSwitchPressed;
	//0x1E padding
};
*/
